...
import { MdOutlineDescription} from 'react-icons/md'
 ...
 function maintenance_corrective() {
  return (
    <div className=" items-center justify-center mt-5 w-full h-full xl:pl-6 xl:pr-6 xl:pb-6 xl:py-6">
      <Head>
        <title>Formulaire de maintenance corrective  </title>
        ...
        <div className="bg-white rounded-2xl shadow-3xl md:w-full xl:w-full  flex-col flex:w-full  ">
          ...
          <div className=" p-5 md:shrink-0">
            ...
            <div className="py-10 text-[#0e1373]">
              <h2 className="text-3xl font-bold mb-2">Maintenance corrective </h2>
              <div className="flex flex-col items-center w-full">
              <div className="bg-gray-100 flex items-center w-64 p-2 mb-3">
                  <MdOutlineSettings className="text-gray-400 m-2" />
                  <input
                    type="textarea"
                    name="Objet maintenance"
                    placeholder="Objet de maintenance"
                ...
                <div className="bg-gray-100 flex items-center w-64 p-2 mb-3">
                  <MdOutlineSettingsInputComposite className="text-gray-400 m-2" />
                  
                  <input
                    type="checklist"
                    name="  Equipement concerné  "
                    placeholder="  Equipement concerné  "
                    className="text-sm bg-gray-100 outline-none flex-1"
                  />
                </div>
                <div className="bg-gray-100 flex items-center w-64 p-2 mb-3">
                  <MdOutlineDescription className="text-gray-400 m-2" /> 
                  <input
                    type="textarea"
                    name="Description"
                ...
                <div className="bg-gray-100 flex items-center w-64 p-2 mb-3">
                  <MdRule className="text-gray-400 m-2" /> 
                  <input
                    type="textarea"
                    name="Consignes"
...
export default maintenance_corrective;
