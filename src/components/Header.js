...
const Header = () => {
  return (
    <div className="d-flex bg-background p-2 shadow-2xl justify-between flex-shrink-0">
      ...
      <Link href="login">
        <button className="d-flex text-sky-100  border border-sky-100/40 mx-5 py-1 pl-2 pr-2 font-semibold shadow-2xl btn mr-2 rounded-lg ">
          Se connecter
        </button>
      </Link>
